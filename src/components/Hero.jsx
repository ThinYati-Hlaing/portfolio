            ...
            <div className="select-none w-full">
                <div className="">
                    <motion.div
                        ...
                        className=" text-3xl mb-5 font-normal text-slate-300"
                    >
                        <motion.h1
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: false }}
                            className="text-5xl mb-5 font-medium text-slate-200"
                        >
                            THIN YATI HLAING
                        </motion.h1>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: false }}
                        transition={{ duration: 1 }}
                        className=" mt-10 mb-5 text-lg text-slate-500 font-sans whitespace-normal"
                    >
                        As a passionate front-end developer, I thrive on the fusion of
                        creativity and technology. My journey in the tech field is fueled by
                        an insatiable curiosity and a commitment to continuous learning. I
                        am dedicated to mastering my craft, expanding my skills, embracing
                    ...
                    <motion.div
                        ...
                        viewport={{ once: false }}
                        transition={{ duration: 1 }}
                        className=" flex mt-2 space-x-3 p-2 cursor-pointer "
                    >
                        <div>
                            <a
